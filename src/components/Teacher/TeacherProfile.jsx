    ...
    const handleSave = async () => {
        const cleanData = {
            ...
            profile: {
                ...
                classManagement: formData.profile.classManagement
            }
        };
        try {
        ...
        <div className="max-w-2xl mx-auto bg-white shadow rounded-lg p-6">
            ...
            <div className="mt-8 border-t border-gray-100 pt-6 space-y-4">
                ...
                <div className="flex justify-between border-b pb-2">
                    ...
                    <span className="font-medium">{user.profile?.teacherCode || "N/A"}</span>
                </div>
                ...
                <div className="flex justify-between border-b pb-2">
                    ...
                    <span className="font-medium">{profile.classManagement || "N/A"}</span>
                </div>
