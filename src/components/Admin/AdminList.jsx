                ...
                <tbody className="text-sm text-gray-600">
                    {admin.map((admin) => (
                        <tr key={admin.id} className="hover:bg-gray-50 border-b last:border-0">
                            ...
                            <td className="p-4 font-bold text-gray-700">{admin.fullName}</td>
                            <td className="p-4 font-bold">{admin.gender}</td>
                            <td className="p-4 font-bold">{admin.phone}</td>
                            <td className="p-4 font-bold">{admin.username}</td>
                            <td className="p-4 font-bold">{admin.password}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
